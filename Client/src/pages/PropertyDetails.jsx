...
import { 
  ...
  ArrowLeft, ArrowRight, Maximize2, Phone, Mail, MessageCircle,
...
const PropertyDetails = () => {
  ...
  const handleFavorite = async () => {
    ...
    try {
      const response = await userAPI.toggleFavorite(property._id);
  ...
  const handleComparison = async () => {
    ...
    try {
      const response = await userAPI.toggleComparison(property._id);
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`p-2 rounded-full transition-colors ${
                  isInComparison ? 'bg-orange-500 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                }`}
              >
          ...
          <div className="space-y-6">
            ...
            {showMessageScreen ? (
              <MessageScreen 
                ...
                onClose={() => setShowMessageScreen(false)}
                property={property}
                otherUser={property?.agent}
                type="inquired"
              />
            ) : (
              <div className="bg-white rounded-lg shadow-sm p-6">
